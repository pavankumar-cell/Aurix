...
export const metadata = {
	title: "Download AURIX | Personal AI Assistant",
	description: "Download AURIX, your personal AI assistant for Windows. Get started with voice conversations, automation, and productivity tools.",
};
