...
export const metadata = {
	title: "Aurix | Building Technology Solutions for the Future",
	description: "Aurix is a technology-driven company creating innovative digital solutions, AI-powered products, automation tools, and intelligent applications designed to simplify tasks and shape the future of technology.",
};
